// =====================================================================
// StudentPortalAI — SESSION PROJECT (fill in the TODOs as the day goes)
...
namespace StudentPortalAI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            string payoffQuestion = "Who teaches C#??";
            ...
            string question)
        {
            ...
            var agent = new SimpleAgent(new List<ITool> { studentTool, courseTool, new InstructorLookupTool(courseDocs) }, ragFallback);
